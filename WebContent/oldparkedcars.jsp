	...
	<%
		...
		try {
			if (parkingId != null && parkingId != "") {
				statement = con.prepareStatement("SELECT datePlaced, timePlaced, hour, booking.carId, name, numberPlate, price FROM booking INNER JOIN car ON booking.carId = car.carId WHERE booking.parkingId = ? AND completion = 1");
