...
<body>
	...
	<ul class="nav nav-tabs">
	  <li class="nav-item">
	    <a class="nav-link active" href="dashboard.jsp">My Cars</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" href="myparking.jsp">My Parking</a>
	  </li>
	  <li class="nav-item">
	  ...
	  <li class="nav-item">
		...
		<a class="badge badge-primary" href="addcar.jsp" style="margin:10px;">Click here to add new car</a>
